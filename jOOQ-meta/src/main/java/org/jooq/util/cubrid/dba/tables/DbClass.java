...
public class DbClass extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	public DbClass(java.lang.String alias) {
		this(alias, org.jooq.util.cubrid.dba.tables.DbClass.DB_CLASS);
	}
	...
	public org.jooq.util.cubrid.dba.tables.DbClass as(java.lang.String alias) {
		return new org.jooq.util.cubrid.dba.tables.DbClass(alias, this);
	}

	/**
	 * Rename this table.
	 */
	public org.jooq.util.cubrid.dba.tables.DbClass rename(java.lang.String name) {
		return new org.jooq.util.cubrid.dba.tables.DbClass(name, null);
	}
}
