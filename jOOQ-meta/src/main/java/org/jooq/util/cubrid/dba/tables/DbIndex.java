...
public class DbIndex extends org.jooq.impl.TableImpl<org.jooq.Record> {
	...
	public DbIndex(java.lang.String alias) {
		this(alias, org.jooq.util.cubrid.dba.tables.DbIndex.DB_INDEX);
	}
	...
	public org.jooq.util.cubrid.dba.tables.DbIndex as(java.lang.String alias) {
		return new org.jooq.util.cubrid.dba.tables.DbIndex(alias, this);
	}

	/**
	 * Rename this table.
	 */
	public org.jooq.util.cubrid.dba.tables.DbIndex rename(java.lang.String name) {
		return new org.jooq.util.cubrid.dba.tables.DbIndex(name, null);
	}
}
